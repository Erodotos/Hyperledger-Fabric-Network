...
import msgs_services_pb2 as msgs__services__pb2


class GreeterStub(object):
    """autogeneration options have not been added yet
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SayHello': grpc.unary_unary_rpc_method_handler(
                    servicer.SayHello,
                    request_deserializer=msgs__services__pb2.HelloRequest.FromString,
                    response_serializer=msgs__services__pb2.HelloReply.SerializeToString,
            ),
    }
